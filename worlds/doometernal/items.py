...
RESERVED_ITEM_IDS = frozenset({
    7770018, 7770019, 7770030, 7770057, 7770105,
...
item_data_table: dict[str, ItemData] = {
    ...
    # Progression & Combat Items (Weapons & Equipment)
    ...
    "Rocket Launcher": ItemData(7770002, ItemClassification.useful, True, True),
    ...
    "Chaingun": ItemData(7770005, ItemClassification.useful, True, True),
    "BFG-9000": ItemData(7770006, ItemClassification.useful, True),
    "The Crucible": ItemData(7770007, ItemClassification.useful),
    ...
    "Frag Grenade": ItemData(7770011, ItemClassification.useful),
    ...
    "Micro Missiles": ItemData(7770061, ItemClassification.useful),
    "Heat Blast": ItemData(7770062, ItemClassification.useful),
    ...
    "Remote Detonate": ItemData(7770071, ItemClassification.useful),
    ...
    "Arbalest": ItemData(7770075, ItemClassification.useful),
    "Arbalest Mastery": ItemData(7770076, ItemClassification.useful),
    "Destroyer Blade": ItemData(7770077, ItemClassification.useful),
    "Destroyer Blade Mastery": ItemData(7770078, ItemClassification.useful),
    "Energy Shield": ItemData(7770079, ItemClassification.useful),
    "Energy Shield Mastery": ItemData(7770080, ItemClassification.useful),
    "Mobile Turret": ItemData(7770081, ItemClassification.useful),
    "Mobile Turret Mastery": ItemData(7770082, ItemClassification.useful),
    "Meat Hook": ItemData(7770083, ItemClassification.useful),
