...
item_data_table: Dict[str, ItemData] = {
    ...
    "Progressive Ammo Upgrade": ItemData(7770125, ItemClassification.progression),
    ...
    "Air Control": ItemData(7770122, ItemClassification.useful),
    "Dazed and Confused": ItemData(7770123, ItemClassification.useful),
    "Saving Throw": ItemData(7770124, ItemClassification.useful),
